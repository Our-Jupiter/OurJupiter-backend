...
public class MailService {
    ...
    @Transactional
    public void mailSend(MailDto mailDto) throws MessagingException, UnsupportedEncodingException {
        ...
        mail.setText(new StringBuffer().append("<h1>당신을 "+mailDto.getGroupName()+"그룹에 초대합니다!</h1>")
                .append("<h3><p>밑의 링크를 클릭하면"+mailDto.getGroupName()+"그룹 가입화면으로 이동합니다.</p></h3>")
